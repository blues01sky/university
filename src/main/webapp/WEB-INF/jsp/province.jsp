...
<meta charset="UTF-8">
    ...
    <div class="zydqr ">
        <div class="zyyxss ">
            <form name="SearchCollege " id="SearchCollege " action="<%=basePath%>area/like" method="post">
                <table width="100% " border="0 " cellspacing="0 " cellpadding="0 ">
                    <tbody><tr>
                        <td width="105 " style="color: red; " align="center "><b class="f14px ">院校搜索：</b></td>
                        <td align="center "><input type="text " name="schoolname " id="keyword " class="zys_01 " style="width:400px;" placeholder="请在这里输入学校名称 " value=""></td>
