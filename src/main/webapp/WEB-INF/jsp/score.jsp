				...
				<div class="nconl">
					<div class="ystab">
						<div class="Menubox">
							<a name="score"></a>
							<ul>
								<li class="hover" id="onz1" onmouseover="setTab(&#39;onz&#39;,1,2,&#39;hover&#39;,&#39;&#39;)">招生与报考</li>
							</ul>
						</div>
						<div class="Contentbox">
							<div id="con_onz_1" style="display: block;">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="zstable" style="margin-top:1px;">
					...
					<div class="sanlt" style="border-top: solid 2px #0000FF;">
						<div class="sanbt fl" style="background-color: royalblue;><b class="f16px">评论</b>
					...
					<div class="olfc">
						...
						<div class="olfcanx"><input class="olfcan" style="color: white;background-color: #1968AA;" type="submit" value="提 交" id="btn_comment"></div>
					</div>
				</div>
				<div class="nconr">
					<div class="nconrt" style="border-bottom: solid 2px red;"><b class="f14px">推荐专业</b></div>
					<div class="nconrc">
						<ul>
							<li>
					...
					<div class="ncheig"></div>
					<div class="nconrt" style="border-bottom: solid 2px red;"><b class="f14px">院校地址</b></div>
					<div class="nconrc">
						<b class="cc00">中国人民大学所在的位置</b><br> 北京市海淀区中关村大街59号
						<br> 所在省份：北京
						<br> 所在城市：
						<br> 联系电话：010-62511340；62511156,010-62511083 <br>
					</div>
					<div class="ncheig"></div>
