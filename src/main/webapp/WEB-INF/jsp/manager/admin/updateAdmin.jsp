...
<title>data属性实现下拉菜单</title>
		<% 
			Admin admin = (Admin)request.getAttribute("result");
		%>
</head>
...
<body>
	...
	<div class="nav col-lg-5">
		<form class="form-horizontal" method="post" action="<%=basePath%>admin/updateadmin">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="hidden" class="form-control" name="adminid" value="<%=admin.getId() %>"> 
					<input type="password" class="form-control" name="adminpassword" value="<%=admin.getPassword() %>">
				</div>
			</div>
