...
<script type="text/javascript"
	src="<%=basePath%>static/jquery/jquery-3.4.1.min.js"></script>
...
<body>
	...
	<div class="nav col-lg-11" style="padding-bottom: 30px;">
		<table class="table table-striped">
			...
			<%
					List<Admin> lists = (List<Admin>)request.getAttribute("result");
			...
			<tr>
				...
				<td><a href="<%=basePath%>admin/addadmin">增加</a></td>
				<td><a href="<%=basePath%>admin/updateadmin?adminid=<%=admin.getId() %>">修改</a></td>
				<td><a
					href="javascript:if(confirm('删除用户<%=admin.getAdminname() %>吗？')) location.href='<%=basePath%>admin/deladmin?adminid=<%=admin.getId() %>'">删除</a>
				</td>
			</tr>
			<%
					}
