...
<body>
	...
	<div class="nav col-lg-5">
		<form class="form-horizontal" method="post" action="<%=basePath%>area/addarea">
			<div class="form-group">
				<label for="username" class="col-sm-2 control-label">学校名称</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="universityname" placeholder="学校名称">
				</div>
			</div>
			<div class="form-group">
				<label for="inputPassword" class="col-sm-2 control-label">所在地区</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="province" placeholder="所在地区">
				</div>
			</div>
			<div class="form-group">
