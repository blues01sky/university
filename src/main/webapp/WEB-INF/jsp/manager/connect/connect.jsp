...
<body>
	...
	<div class="nav col-lg-11" style="padding-bottom: 30px;">
		<table class="table table-striped">
			...
			<%
					List<Connect> lists = (List<Connect>)request.getAttribute("result");
					for(Connect connect : lists){%>
			<tr>
				<td><%=connect.getId() %></td>
				<td><%=connect.getUniversityname() %></td>
				<td><%=connect.getType() %></td>
				<td><%=connect.getProvince() %></td>
				<td><%=connect.getTelphone() %></td>
